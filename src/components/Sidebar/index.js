...
const Sidebar = () => (
    <div className='nav-bar'>
        <Link className='logo' to='/'>
            ...
            <img className="sub-logo" src={LogoSubtitle} alt="eddie" />
        </Link>
        <nav>
            ...
            <NavLink exact="true" activeclassname="active" className="projects-link" to="/projects">
                <FontAwesomeIcon icon={faFileWaveform} color="4d4d4e" />
            </NavLink>
        </nav>
        <ul>
            <li>
                <a target="_blank" rel='noreferrer' href='https://www.linkedin.com/in/eddie-zeng-951066200/'>
